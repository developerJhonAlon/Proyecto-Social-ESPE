...
public class NavegacionController implements Serializable {
    ...
    BigDecimal sistema = new BigDecimal(22);///  codiigo del sistema ojo 
    @EJB
    ...
    public void init() {
        ...
        if (usu_login != null) {
            ...
            setLopciones(this.segOpcionFacade.listaOpcionesHijo(sistema, usu_login.getUsuId()));
...
//            }
    ...
    public void setLopciones(List<SegOpcion> lopciones) {
        ...
        System.out.println(" lopcione s" + lopciones.size());
    }
    ...
    public void verificar_session() throws IOException {
        ExternalContext ec = FacesContext.getCurrentInstance().getExternalContext();
        //ec.invalidateSession();
        //ec.redirect(ec.getRequestContextPath());
